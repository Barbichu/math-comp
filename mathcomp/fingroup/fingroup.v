...
Proof.
apply/setP=> xy /[1!inE]; apply/imsetP/imsetP=> [] [y Ay def_xy].
...
Proof. by apply/group_setP; split=> [|x y _ _] /[1!inE]. Qed.
...
Proof.
rewrite -[[~: A, B]]genV; congr <<_>>; apply/setP=> z /[1!inE].
...
Proof.
apply/subsetP=> x Gx /[1!inE]; apply/bigcapsP=> y Gy.
...
Proof. by apply: big_pred1 => y /= /[1!inE]. Qed.
...
Proof.
apply/subsetP=> x /centP cAx /[1!inE].
