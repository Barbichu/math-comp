...
Proof. by apply/subsetP=> x /[1!inE]. Qed.
...
by apply/setP=> x /[1!inE]; apply: A0.
Qed.
...
Proof. by apply/subsetP=> x /[1!inE]; case/andP. Qed.
...
Proof. by apply/setP => y /[1!inE]; apply/imsetP=> [[x]] /[1!inE]. Qed.
...
by case/imsetP=> x Ax ->; move/sAf'B: Ax => /[1!inE].
Qed.
...
Proof. by apply: big_pred0 => i /[1!inE]. Qed.
...
Proof. by apply: eq_bigl => i /[1!inE]. Qed.
...
elim/big_rec: _ => [|i V Pi sUV]; apply/subsetP=> x Ux /[1!inE]//.
...
elim: {P}(enum _) (enum_uniq (mem P)) => [_ | A e IHe] /=.
  by rewrite /trivIset /cover !big_set0 cards0; left=> A /[1!inE].
...
Proof.
by rewrite -mem_pblock /pblock; case: pickP => [A /andP[]| _] //= /[1!inE].
Qed.
...
rewrite big_trivIset // /rhs big_imset => [|i j _ /setIdP[_ notFj0] eqFij].
  rewrite big_mkcond; apply: eq_bigr => i _ /[1!inE].
...
Proof.
rewrite /fix_order; case: eqP; last by move=>/negP/negPf-> /[1!inE].
